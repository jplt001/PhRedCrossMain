...
<head>
  ...
  <title>Philippine Red Cross | Log in</title>
...
<body class="hold-transition login-page" style="background: #BF2328;">
<div class="login-box">
  <div class="login-logo">
    <div style='width:200px'>
      <img src="../public/img/logo.png" style='margin-left:50%;height:auto; width:150px;'>
    </div>
    <a href="{{ URL::to('/')}}" style="color: white;">Philippine <b>Red</b> Cross</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    ...
    <form method="POST" action="{{ route('login') }}">
      ...
      <div class="form-group has-feedback {{ $errors->has('email') ? ' has-error' : '' }}">
        <input id="email" type="email" class="form-control" name="email" value="jplt.developer001@gmail.com" required autofocus>
      ...
      <div class="form-group has-feedback {{ $errors->has('password') ? ' has-error' : '' }}">
        <input id="password" type="password" class="form-control" name="password" value="123" required>
